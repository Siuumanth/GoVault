...
func NewServiceRegistry(r *repository.RepoRegistry, storage storage.FileStorage, authClient *clients.AuthClient) *ServiceRegistry {
	return &ServiceRegistry{
		Files:     files.NewFileService(r.Files, r.Shares, storage),
		Shares:    shares.NewShareService(r.Shares, r.Files, authClient),
